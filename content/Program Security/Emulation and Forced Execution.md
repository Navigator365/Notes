...
So, a couple new strategies emerged: 
- **Fuzzing**: Randomly perturb input to get a new input, and keep trying. This is pretty dumb, and pure randomness doesn't really work for large and highly complex programs. 
- **Symbolic execution**: Represent program code mathematically, and solve to "execute" all the code. This REALLY doesn't scale well, though it can catch very complex patterns/states. 
